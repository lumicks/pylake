...
def test_integration_active_calibration_hydrodynamics(integration_test_parameters):
    ...
    np.testing.assert_allclose(fit.results["Rd"].value, 0.6051649595952255, rtol=1e-6)
    np.testing.assert_allclose(fit.results["kappa"].value, 0.10543255387030766, rtol=1e-6)
    np.testing.assert_allclose(fit.results["Rf"].value, 63.80408720294617, rtol=1e-6)
    np.testing.assert_allclose(fit.results["gamma_0"].value, 1.0678273429551705e-08, rtol=1e-6)
    np.testing.assert_allclose(fit.results["gamma_ex"].value, 1.1141607635200364e-08, rtol=1e-6)
    np.testing.assert_allclose(fit.results["fc"].value, 1506.0763814952134, rtol=1e-6)
    np.testing.assert_allclose(fit.results["D"].value, 1.0088409193697105, rtol=1e-6)
    np.testing.assert_allclose(fit.results["f_diode"].value, 14678.936672826007, rtol=1e-6)
    np.testing.assert_allclose(fit.results["alpha"].value, 0.41654273269237857, rtol=1e-6)
    ...
    np.testing.assert_allclose(fit.results["chi_squared_per_deg"].value, 0.8650977340600331, rtol=1e-6)
    np.testing.assert_allclose(fit.results["backing"].value, 14.18433881880926, rtol=1e-6)
...
def test_integration_passive_calibration_hydrodynamics(integration_test_parameters):
    ...
    np.testing.assert_allclose(fit.results["Rd"].value, 0.6181547131898849, rtol=1e-6)
    np.testing.assert_allclose(fit.results["kappa"].value, 0.1010480422094705, rtol=1e-6)
    np.testing.assert_allclose(fit.results["Rf"].value, 62.46332355039462, rtol=1e-6)
    np.testing.assert_allclose(fit.results["gamma_0"].value, 1.0678273429551705e-08, rtol=1e-6)
    np.testing.assert_allclose(fit.results["fc"].value, 1506.0763814952134, rtol=1e-6)
    np.testing.assert_allclose(fit.results["D"].value, 1.0088409193697105, rtol=1e-6)
    np.testing.assert_allclose(fit.results["f_diode"].value, 14678.936672826007, rtol=1e-6)
