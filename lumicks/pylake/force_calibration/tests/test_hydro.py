...
def test_integration_active_calibration_hydrodynamics(integration_test_parameters):
    ...
    np.testing.assert_allclose(fit.results["Rd"].value, 0.6051649438939418)
    np.testing.assert_allclose(fit.results["kappa"].value, 0.10543255915119677)
    np.testing.assert_allclose(fit.results["Rf"].value, 63.80408874332869)
    np.testing.assert_allclose(fit.results["gamma_0"].value, 1.0678273429551705e-08)
    np.testing.assert_allclose(fit.results["gamma_ex"].value, 1.1141607903678828e-08)
    np.testing.assert_allclose(fit.results["fc"].value, 1506.0764206395213)
    np.testing.assert_allclose(fit.results["D"].value, 1.0088409474094346)
    np.testing.assert_allclose(fit.results["f_diode"].value, 14678.934354735959)
    np.testing.assert_allclose(fit.results["alpha"].value, 0.4165428288095913)
    np.testing.assert_allclose(fit.results["err_fc"].value, 14.276228730404862, rtol=1e-5)
    np.testing.assert_allclose(fit.results["err_D"].value, 0.006159815672431939, rtol=1e-5)
    np.testing.assert_allclose(fit.results["err_f_diode"].value, 340.241798753331, rtol=1e-5)
    np.testing.assert_allclose(fit.results["err_alpha"].value, 0.014036662305954087, rtol=1e-5)
    np.testing.assert_allclose(fit.results["chi_squared_per_deg"].value, 0.8650977340590755)
    np.testing.assert_allclose(fit.results["backing"].value, 14.184338818641473)
...
def test_integration_passive_calibration_hydrodynamics(integration_test_parameters):
    ...
    np.testing.assert_allclose(fit.results["Rd"].value, 0.6181547045993891)
    np.testing.assert_allclose(fit.results["kappa"].value, 0.10104804483580189)
    np.testing.assert_allclose(fit.results["Rf"].value, 62.46332430582095)
    np.testing.assert_allclose(fit.results["gamma_0"].value, 1.0678273429551705e-08)
    np.testing.assert_allclose(fit.results["fc"].value, 1506.0764206395213)
    np.testing.assert_allclose(fit.results["D"].value, 1.0088409474094346)
    np.testing.assert_allclose(fit.results["f_diode"].value, 14678.934354735959)
...
def test_integration_active_calibration_hydrodynamics_bulk(integration_test_parameters):
    ...
    np.testing.assert_allclose(fit.results["Rd"].value, 0.6124727675136632)
    np.testing.assert_allclose(fit.results["kappa"].value, 0.10261253581864228)
    np.testing.assert_allclose(fit.results["Rf"].value, 62.84738379443874)
    np.testing.assert_allclose(fit.results["gamma_0"].value, 1.0678273429551705e-08)
    np.testing.assert_allclose(fit.results["gamma_ex"].value, 1.0874447095465092e-08)
    np.testing.assert_allclose(fit.results["fc"].value, 1501.8043819020124)
    np.testing.assert_allclose(fit.results["D"].value, 1.0091072929807905)
    np.testing.assert_allclose(fit.results["f_diode"].value, 14669.854765640192)
    np.testing.assert_allclose(fit.results["alpha"].value, 0.41657475124350934)
    np.testing.assert_allclose(fit.results["err_fc"].value, 11.599574315820544, rtol=1e-5)
    np.testing.assert_allclose(fit.results["err_D"].value, 0.007332342009653214, rtol=1e-5)
    np.testing.assert_allclose(fit.results["err_f_diode"].value, 376.8356785987149, rtol=1e-5)
    np.testing.assert_allclose(fit.results["err_alpha"].value, 0.01465351988261642, rtol=1e-5)
    np.testing.assert_allclose(fit.results["chi_squared_per_deg"].value, 0.869222469346555)
    np.testing.assert_allclose(fit.results["backing"].value, 14.91905312354037)
