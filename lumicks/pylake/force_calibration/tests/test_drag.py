...
@pytest.mark.parametrize(
    ...
    [
        ...
        [0.0, 3.0e-6, 0.5e-6, True, 0.8870658857069117, False],
        [0.0, 6.0e-6, 0.5e-6, False, 0.9409521069093458, False],
        [0.0, 1.0, 1.0e-6, True, 0.9999992500005626, False],
        [3.0e-6, 0.0, 0.5e-6, True, 0.8870658857069117, True],
        [6.0e-6, 0.0, 0.5e-6, False, 0.9409521069093458, True],
        [1.0, 0.0, 1.0e-6, True, 0.9999992500005626, True],
        [3.0e-6, 0.0e-6, 0.5e-6, True, 0.8047217606699633, False],
        [0.0, 3.0e-6, 0.5e-6, True, 0.8047217606699633, True],
        # When the beads are diagonal, it doesn't matter whether we oscillate vertically or
        # horizontally.
        [3.0e-6, 3.0e-6, 0.5e-6, True, 0.8847854060183502, True],
        [-3.0e-6, -3.0e-6, 0.5e-6, True, 0.8847854060183502, True],
        [3.0e-6, -3.0e-6, 0.5e-6, True, 0.8847854060183502, True],
        [3.0e-6, 3.0e-6, 0.5e-6, True, 0.8847854060183502, True],
        [3.0e-6, 3.0e-6, 0.5e-6, True, 0.8847854060183502, False],
        [-3.0e-6, -3.0e-6, 0.5e-6, True, 0.8847854060183502, False],
        [3.0e-6, -3.0e-6, 0.5e-6, True, 0.8847854060183502, False],
        [3.0e-6, 3.0e-6, 0.5e-6, True, 0.8847854060183502, False],
    ],
