...
class PassiveCalibrationModel:
    ...
    def __init__(
        ...
        if hydrodynamically_correct:
            ...
            # The hydrodynamic model is expressed as a function of drag in bulk. Therefor,
            # to get the local drag, we have to forward-calculate it.
            self._to_local_drag_coefficient = calculate_complex_drag(
                f=0,
                gamma0=1,
            ...
            self._to_local_drag_coefficient = 1
