...
def test_likelihood(exponential_data):
    ...
    fit = _exponential_mle_optimize(1, dataset["data"], *dataset["parameters"].observation_limits)
    ...
    fit = _exponential_mle_optimize(2, dataset["data"], *dataset["parameters"].observation_limits)
