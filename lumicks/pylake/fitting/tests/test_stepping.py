...
@pytest.mark.parametrize(
    "origin,step,lb,ub,result",
    [
        # Positive quadrant
        ([1, 1], [-2, -4], [0, 0], [2, 2], [0.5, 0.0]),
        ([1, 1], [-4, -4], [0, 0], [2, 2], [0, 0]),
        ([1, 1], [4, 4], [0, 0], [2, 2], [2, 2]),
        ([1, 1], [2, 4], [0, 0], [2, 2], [1.5, 2]),
        ([1, 1], [-2, 4], [0, 0], [2, 2], [0.5, 2]),
        ([1, 1], [2, -4], [0, 0], [2, 2], [1.5, 0]),
        ([1, 1], [0, 0.5], [0, 0], [2, 2], [1.0, 1.5]),
        ([1, 1], [0.5, 0], [0, 0], [2, 2], [1.5, 1]),
        ([1, 1], [-0.5, 0], [0, 0], [2, 2], [0.5, 1]),
        ([1, 1], [-0.5, -0.5], [0, 0], [2, 2], [0.5, 0.5]),
        ([3, 3], [-0.5, 0.0], [2, 2], [4, 4], [2.5, 3.0]),
        ([3, 3], [-10.0, 0.0], [2, 2], [4, 4], [2.0, 3.0]),
        # Negative quadrant
        ([-1, -1], [-2, -4], [-2, -2], [0, 0], [-1.5, -2]),
        ([-1, -1], [-4, -4], [-2, -2], [0, 0], [-2, -2]),
        ([-1, -1], [4, 4], [-2, -2], [0, 0], [0, 0]),
        ([-1, -1], [2, 4], [-2, -2], [0, 0], [-0.5, 0]),
        ([-1, -1], [-2, 4], [-2, -2], [0, 0], [-1.5, 0.0]),
        ([-1, -1], [2, -4], [-2, -2], [0, 0], [-0.5, -2]),
        # Both quadrants
        ([-1, -1], [-2, -4], [-2, -2], [2, 2], [-1.5, -2]),
        ([-1, -1], [-4, -4], [-2, -2], [2, 2], [-2, -2]),
        ([-1, -1], [4, 4], [-2, -2], [2, 2], [2, 2]),
        ([-1, -1], [2, 4], [-2, -2], [2, 2], [-1.0 + 2.0 * (3.0 / 4.0), 2]),
        ([-1, -1], [-2, 4], [-2, -2], [2, 2], [-2.0, 1.0]),
        ([-1, -1], [2, -4], [-2, -2], [2, 2], [-0.5, -2.0]),
    ],
)
def test_clamp_vector(origin, step, lb, ub, result):
    np.testing.assert_allclose(
        clamp_step(np.asarray(origin), np.asarray(step), np.asarray(lb), np.asarray(ub))[0],
        np.asarray(result),
    )
...
@pytest.mark.parametrize(
    "chi2_function,start_pos,step_sign,target_step_size,target_p_trial",
    [
        (
            lambda x: 5,
            np.array([2, 2]),
            1,
            cfg.max_abs_step,
            np.array([2.0 + cfg.max_abs_step, 2.0 + cfg.max_abs_step]),
        ),
        ...
        (FlippingCost(), np.array([2, 2]), 1, 0.5, np.array([2.5, 2.5])),
    ],
)
