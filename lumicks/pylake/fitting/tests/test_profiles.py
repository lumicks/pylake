...
def test_profiles():
    ...
    def validate_profile(name, func, jac, x, y, parameter, lb, ub):
    ...
    validate_profile("linear", linear, linear_jac, x, y, "a", 2.6713088215948138, 5.096607466976615)
    validate_profile("linear", linear, linear_jac, x, y, "b", 0.8928141799335386, 9.643510828637888)
    validate_profile("quad", quad, quad_jac, x, y, "a", -0.14811649590123688, 1.1064951859012375)
    validate_profile("quad", quad, quad_jac, x, y, "b", -2.9084849155213455, 4.9261290640927715)

    with pytest.raises(KeyError):
        validate_profile("linear", linear, linear_jac, x, y, "d", 2.6713088215948138, 5.096607466976615)
