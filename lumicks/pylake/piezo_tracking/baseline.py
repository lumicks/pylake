...
from lumicks.pylake.channel import Slice, Continuous, match_sample_rates
...
class ForceBaseLine:
    ...
    def __init__(self, model, trap_data, force):
        ...
        self._trap_data, self._force = match_sample_rates([trap_data, force], where="left")
    ...
    def correct_data(self, force, trap_position):
        ...
        """
        # Ensure force and position have the same sample rate, downsample to the left to keep timestamps aligned.
        trap_position, force = match_sample_rates([trap_position, force], where="left")
