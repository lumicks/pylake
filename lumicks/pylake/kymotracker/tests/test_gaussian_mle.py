...
def test_likelihood(gaussian_1d):
    ...
    expectation_fcn = partial(
        gaussian_mle.peak_expectation_1d, coordinates, pixel_size=params.pixel_size
    )
...
def test_likelihood_jacobian(gaussian_1d):
    ...
    derivatives_fcn = partial(
        gaussian_mle.peak_expectation_1d_derivatives, coordinates, pixel_size=params.pixel_size
    )
